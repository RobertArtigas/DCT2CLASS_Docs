...
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#TEMPLATE(zClassesBaseClass,'2022.02.24.09.16.51: zClassesBaseClass [GENERATED] Version: 1.00'),FAMILY('CW20','ABC')
#!
#INCLUDE('cape01.tpw')
#INCLUDE('cape02.tpw')
#!
...
#INSERT(%SetFamily)
#FOR(%ApplicationTemplate),WHERE(%ApplicationTemplate='GlobalzClassesBaseClass(zClassesBaseClass)')
  #FOR(%ApplicationTemplateInstance)
    #CONTEXT(%Application,%ApplicationTemplateInstance)
      #INSERT(%ReadClassesPR,'cClassesBaseClass.inc',%pa,%force)
...
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#EXTENSION(GlobalzClassesBaseClass,'2022.02.24.09.16.51: zClassesBaseClass [GENERATED] Version: 1.00'),APPLICATION(zClassesBaseClass)
#!
#INSERT(%PreambleMe)
#!
#SHEET,HSCROLL
  ...
  #TAB(UPPER(%Application) & '.' & UPPER(%ProgramExtension))
    #BOXED('GlobalzClassesBaseClass')
      #DISPLAY(''),AT(,,,1)
      #DISPLAY('cClassesBaseClass')
    ...
    #BOXED('Debugging Global')
      #PROMPT('Disable All Global cClassesBaseClass Features',CHECK),%NoGlobalzClassesBaseClass,AT(10)
    #ENDBOXED
    #INSERT(%ClarionFamily)
  #ENDTAB
  #TAB('Multi-Dll'),WHERE(%NoGlobalzClassesBaseClass=0)
    #BOXED('')
...
#ENDSHEET
#!
#AT(%AfterGlobalIncludes),WHERE(%NoGlobalzClassesBaseClass=0)
  INCLUDE('cClassesBaseClass.inc'),ONCE
  #INSERT(%IncludeAdditionalIncFiles)
#ENDAT
#!
#ATSTART
  #IF(%NoGlobalzClassesBaseClass=0)
...
#ENDAT
#!
#AT(%DllExportList),WHERE(%ProgramExtension='DLL' AND %RootDLL=1 AND %MultiDll=1 AND %NoGlobalzClassesBaseClass=0)
#INSERT(%ExportClassesPR,'cClassesBaseClass.inc')
#INSERT(%ExportAdditionalIncFiles)
#ENDAT
#!
#AT(%CustomGlobalDeclarations),WHERE(%NoGlobalzClassesBaseClass=0)
#INSERT(%Defines,1,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%mpDefineAll),WHERE(%NoGlobalzClassesBaseClass=0)
#INSERT(%Defines,2,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%mpDefineAll7),WHERE(%NoGlobalzClassesBaseClass=0)
#INSERT(%Defines,3,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%BeforeGlobalIncludes),WHERE(%NoGlobalzClassesBaseClass=0)
RelVer:zClassesBaseClass EQUATE('Rel:2022.02.24.09.16.51-Ver:1.00')
#ENDAT
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#EXTENSION(LocalzClassesBaseClass, ' 2022.02.24.09.16.51: LOCAL zClassesBaseClass [GENERATED] Version: 1.00'),PROCEDURE,REQ(GlobalzClassesBaseClass(zClassesBaseClass))
#!
#INSERT(%PreambleMe)
#!
#SHEET,HSCROLL
  ...
  #TAB(UPPER(%Application) & '.' & UPPER(%ProgramExtension))
    ...
    #BOXED('Debugging Local')
      #PROMPT('Disable Local cClassesBaseClass Features',CHECK),%NoLocalzClassesBaseClass,AT(10)
    #ENDBOXED
    #INSERT(%ClarionFamily)
  #ENDTAB
  #TAB('Classes')
    #BOXED('')
      #DISPLAY(''),AT(,,,1)
      #PROMPT('&Object Name',@s100),%zObjectName,DEFAULT('CLA_oBaseClass')
      #PROMPT('&Class Name',@s100),%zClassName,DEFAULT('cClassesBaseClass')
    #ENDBOXED
  #ENDTAB
#ENDSHEET
#!
#ATSTART
  #IF(%NoLocalzClassesBaseClass=0)
    #INSERT(%AtStartInitialisation)
    #INSERT(%AddObjectPR,%zClassName,%zObjectName,'Local Objects')
  #ENDIF
#ENDAT
#!
#AT(%DataSection),WHERE(%NoLocalzClassesBaseClass=0),DESCRIPTION('LocalzClassesBaseClass - Class Definition'),PRIORITY(2700)
#INSERT(%GenerateClassDeclaration,%zClassName,%zObjectName,'Local Objects','RYB Objects')
#ENDAT
#!
#AT(%LocalProcedures),WHERE(%NoLocalzClassesBaseClass=0),DESCRIPTION('LocalzClassesBaseClass - Class Definition')
