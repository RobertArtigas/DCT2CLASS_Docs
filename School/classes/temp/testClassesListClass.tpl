...
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#TEMPLATE(testClassesListClass,'2021.04.18.07.39.42: testClassesListClass [GENERATED] Version: 1.00'),FAMILY('CW20','ABC')
#!
#INCLUDE('cape01.tpw')
#INCLUDE('cape02.tpw')
#!
...
#!
#EQUATE(%tplVer  , '1.00')
#EQUATE(%tplRel  , '2021.04.18.07.39.42')
#!
...
#INSERT(%SetFamily)
#FOR(%ApplicationTemplate),WHERE(%ApplicationTemplate='GlobaltestClassesListClass(testClassesListClass)')
  #FOR(%ApplicationTemplateInstance)
    #CONTEXT(%Application,%ApplicationTemplateInstance)
      #INSERT(%ReadClassesPR,'testClassesListClass.inc',%pa,%force)
...
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#EXTENSION(GlobaltestClassesListClass,'2021.04.18.07.39.42: testClassesListClass [GENERATED] Version: 1.00'),APPLICATION(testClassesListClass)
#!
#INSERT(%PreambleMe)
#!
#SHEET,HSCROLL
  ...
  #TAB(UPPER(%Application) & '.' & UPPER(%ProgramExtension))
    #BOXED('GlobaltestClassesListClass')
      #DISPLAY(''),AT(,,,1)
      #DISPLAY('testClassesListClass')
    ...
    #BOXED('Debugging Global')
      #PROMPT('Disable All Global testClassesListClass Features',CHECK),%NoGlobaltestClassesListClass,AT(10)
    #ENDBOXED
    #INSERT(%ClarionFamily)
  #ENDTAB
  #TAB('Multi-Dll'),WHERE(%NoGlobaltestClassesListClass=0)
    #BOXED('')
...
#ENDSHEET
#!
#AT(%AfterGlobalIncludes),WHERE(%NoGlobaltestClassesListClass=0)
  INCLUDE('testClassesListClass.inc'),ONCE
  #INSERT(%IncludeAdditionalIncFiles)
#ENDAT
#!
#ATSTART
  #IF(%NoGlobaltestClassesListClass=0)
...
#ENDAT
#!
#AT(%DllExportList),WHERE(%ProgramExtension='DLL' AND %RootDLL=1 AND %MultiDll=1 AND %NoGlobaltestClassesListClass=0)
#INSERT(%ExportClassesPR,'testClassesListClass.inc')
#INSERT(%ExportAdditionalIncFiles)
#ENDAT
#!
#AT(%CustomGlobalDeclarations),WHERE(%NoGlobaltestClassesListClass=0)
#INSERT(%Defines,1,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%mpDefineAll),WHERE(%NoGlobaltestClassesListClass=0)
#INSERT(%Defines,2,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%mpDefineAll7),WHERE(%NoGlobaltestClassesListClass=0)
#INSERT(%Defines,3,'LinkMode','DllMode',%MultiDLL,%RootDll)
#ENDAT
#!
#AT(%BeforeGlobalIncludes),WHERE(%NoGlobaltestClassesListClass=0)
RelVer:testClassesListClass EQUATE('Rel:2021.04.18.07.39.42-Ver:1.00')
#ENDAT
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#!-----------------------------------------------------------------------------------------------------
#EXTENSION(LocaltestClassesListClass, ' 2021.04.18.07.39.42: LOCAL testClassesListClass [GENERATED] Version: 1.00'),PROCEDURE,REQ(GlobaltestClassesListClass(testClassesListClass))
#!
#INSERT(%PreambleMe)
#!
#SHEET,HSCROLL
  ...
  #INSERT(%LicenseMe)
  #TAB(UPPER(%Application) & '.' & UPPER(%ProgramExtension))
    #BOXED('LocaltestClassesListClass')
      #DISPLAY(''),AT(,,,1)
      #DISPLAY('testClassesListClass')
      #DISPLAY('Templates copyright (c) by each individual author.')
      #DISPLAY('E-MAIL: roberto.artigas.dev@gmail.com')
    ...
    #BOXED('Debugging Local')
      #PROMPT('Disable Local testClassesListClass Features',CHECK),%NoLocaltestClassesListClass,AT(10)
    #ENDBOXED
    #INSERT(%ClarionFamily)
  #ENDTAB
  #TAB('Classes')
    #BOXED('')
      ...
      #PROMPT('&Class Name',@s100),%zClassName,DEFAULT('testClassesListClass')
    #ENDBOXED
  #ENDTAB
#ENDSHEET
#!
#ATSTART
  #IF(%NoLocaltestClassesListClass=0)
    #INSERT(%AtStartInitialisation)
    #INSERT(%AddObjectPR,%zClassName,%zObjectName,'Local Objects')
  #ENDIF
#ENDAT
#!
#AT(%DataSection),WHERE(%NoLocaltestClassesListClass=0),DESCRIPTION('LocaltestClassesListClass - Class Definition'),PRIORITY(2700)
#INSERT(%GenerateClassDeclaration,%zClassName,%zObjectName,'Local Objects','RYB Objects')
#ENDAT
#!
#AT(%LocalProcedures),WHERE(%NoLocaltestClassesListClass=0),DESCRIPTION('LocaltestClassesListClass - Class Definition')
